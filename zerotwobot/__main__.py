...
from zerotwobot import dispatcher, updater, TOKEN, WEBHOOK, OWNER_ID, DONATION_LINK, CERT_PATH, PORT, URL, LOGGER, \
    ALLOW_EXCL
...
PM_START_TEXT = """
Hi {}, my name is {}! If you have any questions on how to use me, read /help - and then head to @joker_hacker_6521.

I'm a group manager bot built in python3, using the python-telegram-bot library, and am fully opensource; \
you can find what makes me tick [here](github.com/jokerhacker22/harley_quinzel_bot)!

Feel free to submit pull requests on github, or to contact me, @joker_hacker_6521, with any bugs, questions \
...
There are two ways of paying him; `Currently unavailable`."""
